 ...
 */
                ...
                return function() {
                    ...
                    return h.prototype.buildTemplates = function() {
                        ...
                        this.zoomableTimeout = setTimeout((function() {
                            t.isImageSlide() && (t.core.getSlideItem(e.detail.index).addClass("lg-zoomable"), 
                        ...
                        if (!(Math.abs(t) <= 0)) {
                            ...
                            var h, m, u = this.getPossibleSwipeDragCords(t), d = n - this.pageX, p = r - this.pageY;
                            if (e - t > 1) {
                                var f = (e - t) / Math.abs(t);
                                h = (d = (t < 0 ? -d : d) + this.left * (f + (t < 0 ? -1 : 1))) / f, m = (p = (t < 0 ? -p : p) + this.top * (f + (t < 0 ? -1 : 1))) / f;
                            } else h = d * (f = (e - t) * t), m = p * f;
                            if (o && (c ? this.isBeyondPossibleLeft(h, u.minX) ? h = u.minX : this.isBeyondPossibleRight(h, u.maxX) && (h = u.maxX) : e > 1 && (h < u.minX ? h = u.minX : h > u.maxX && (h = u.maxX)), 
                    ...
                    }, h.prototype.resetImageTranslate = function() {
                        var e = this.core.getSlideItem(this.core.index).find(".lg-image").first();
                        this.imageReset = !1, e.removeClass("reset-transition reset-transition-y reset-transition-x"), 
                        this.core.outer.removeClass("lg-actual-size"), e.css("width", "auto").css("height", "auto"), 
                        setTimeout((function() {
                        ...
                        this.resetImageTranslate(), setTimeout((function() {
                        ...
                        if (this.settings.zoom) {
                            ...
                            this.core.outer.on("dblclick.lg", (function(t) {
                                ...
                                if (e.core.lgOpened && e.isImageSlide() && !e.core.touchAction) {
                                ...
                                if (e.isImageSlide()) {
                                    var t = 0;
                                    e.imageReset && (e.resetImageTranslate(), t = 50), setTimeout((function() {
                                ...
                                e.scale = 1, e.positionChanged = !1, e.resetZoom(o), e.isImageSlide() && e.setZoomEssentials();
                        ...
                        this.core.outer.on("touchstart.lg", (function(o) {
                            if (a = e.core.getSlideItem(e.core.index), e.isImageSlide() && 2 === o.touches.length) {
                                ...
                                e.setPageCords(o), e.resetImageTranslate(), e.core.touchAction = "pinch", t = e.getTouchDistance(o);
                            }
                        ...
                        this.core.$inner.on("touchstart.lg", (function(s) {
                            if (o.isImageSlide() && (g = o.core.getSlideItem(o.core.index), (o.$LG(s.target).hasClass("lg-item") || g.get().contains(s.target)) && 1 === s.touches.length && o.core.outer.hasClass("lg-zoomed"))) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".top-slider__slider")) new core(".top-slider__slider", {
            ...
            if (document.querySelector(".bottom-slider__slider")) new core(".bottom-slider__slider", {
...
***************************************************************************** */
        ...
        var lg_fullscreen_min = __webpack_require__(159);
        var lg_pager_min = __webpack_require__(941);
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_thumbnail_min, lg_fullscreen_min, lg_pager_min, lg_zoom_min ],
